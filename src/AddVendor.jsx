...
export class AddVendor extends Component { 
      ...
      <Container className="container-sec">
        <Form>
          ...
          <Form.Group className="mb-3" controlId="formBasicPassword">
            ...
            <Form.Control type="text" placeholder="Enter Address" name="address" onChange={this.onChangeHandler} />
          </Form.Group>

          <Form.Group className="mb-3" controlId="formBasicEmail">
            <Form.Label>City</Form.Label>
            <Form.Select name="city" onChange={this.onChangeHandler} >
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="text" placeholder="Enter Contact" name="contact" onChange={this.onChangeHandler} />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Select name="specs" onChange={this.onChangeHandler} >
              <option value="">---select business type---</option>
          ...
          <Button variant="primary" onClick={this.onvendorSubmit}>
            Submit
          </Button>
        </Form>
      </Container>
  ...
  onvendorSubmit = () => {
    ...
    this.props.addVendor(this.state.vendor);
  }
