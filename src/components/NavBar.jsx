        ...
        <Navbar bg="dark" variant="dark" className="navbar">
          <Container>
            ...
            <Nav className="me-auto">
              ...
              <Nav.Link><Link to="/add-vendor" className="link">Add Vendor</Link></Nav.Link>
              <Nav.Link><Link to="/vendors" className="link">Vendor List</Link></Nav.Link>

              {/* <Nav.Link><Link to="/add-order" className="link">Add Order</Link></Nav.Link> */}
              <Nav.Link><Link to="/orders" className="link">Order List</Link></Nav.Link>
            </Nav>
